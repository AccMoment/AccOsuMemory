...
public partial class MenuButton : UserControl
{
    ...
    public static readonly DirectProperty<MenuButton, string?> BtnContentProperty =
        AvaloniaProperty.RegisterDirect<MenuButton, string?>(
            "btnContent", o => o.BtnContent, (o, v) => o.BtnContent = v);

    private bool _isSelect;

    public static readonly DirectProperty<MenuButton, bool> IsSelectProperty =
        AvaloniaProperty.RegisterDirect<MenuButton, bool>(
