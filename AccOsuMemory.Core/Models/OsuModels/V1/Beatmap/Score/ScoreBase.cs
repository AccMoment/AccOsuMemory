...
{
    [JsonPropertyName("score_id")] public long ScoreId { get; set; }
    ...
    [JsonPropertyName("countmiss")] public int CountMiss { get; set; }
    ...
    [JsonPropertyName("enabled_mods")] public int EnabledMods { get; set; }
