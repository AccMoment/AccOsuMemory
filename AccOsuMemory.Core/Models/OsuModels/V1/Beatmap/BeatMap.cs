...
public class BeatMap
{
    ...
    [JsonPropertyName("diff_size")] public double DiffSize { get; set; }

    [JsonPropertyName("diff_overall")] public double DiffOverall { get; set; }

    [JsonPropertyName("diff_approach")] public double DiffApproach { get; set; }

    [JsonPropertyName("diff_drain")] public double DiffDrain { get; set; }

    [JsonPropertyName("mode")]
    [JsonConverter(typeof(JsonStringEnumConverter))]
    public GameMode Mode { get; set; }

    [JsonPropertyName("count_normal")] public int CountNormal { get; set; }

    [JsonPropertyName("count_slider")] public int CountSlider { get; set; }

    [JsonPropertyName("count_spinner")] public int CountSpinner { get; set; }
