...
namespace AccOsuMemory.Core.Models.OsuModels.V1.User;
...
public class UserInfo
{
    ...
    [JsonPropertyName("count300")] public int Count300 { get; set; }

    [JsonPropertyName("count100")] public int Count100 { get; set; }
    ...
    [JsonPropertyName("pp_rank")] public int Rank { get; set; }

    [JsonPropertyName("level")] public double Level { get; set; }

    [JsonPropertyName("pp_raw")] public double ppRaw { get; set; }

    [JsonPropertyName("accuracy")] public double Accuracy { get; set; }

    [JsonPropertyName("count_rank_ss")] public int CountRankSS { get; set; }

    [JsonPropertyName("count_rank_ssh")] public int CountRankSSH { get; set; }

    [JsonPropertyName("count_rank_s")] public int CountRankS { get; set; }

    [JsonPropertyName("count_rank_sh")] public int CountRankSH { get; set; }

    [JsonPropertyName("count_rank_a")] public int CountRankA { get; set; }
    ...
    [JsonPropertyName("pp_country_rank")] public int CountryRank { get; set; }
